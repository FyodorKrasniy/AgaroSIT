...
{
    private string subscriptionKey = "5e0be83bb0f940a7817d8c23a483e306";
...
private static bool TrustCertificate(object sender, X509Certificate x509Certificate, X509Chain x509Chain, SslPolicyErrors sslPolicyErrors)
...

    {
        ...
        HttpWebRequest request = (HttpWebRequest)WebRequest.Create("https://australiaeast.api.cognitive.microsoft.com/sts/v1.0/issuetoken");
    ...
    public void SpeechToText(byte[] wavData)
    {
        ...
        string fetchUri = "https://australiaeast.stt.speech.microsoft.com/speech/recognition/conversation/cognitiveservices/v1"; //if errors - check the web code is right? //200 is corrct signal
        ...
        debug.text = "Responsefrom service: " + responseString;
